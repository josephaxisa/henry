...
class LookerApi(object):
    ...
    def auth(self):
        ...
        self.api_logger.info('Request to %s => POST /api/3.0/login, %s', self.host, {key: (value if key == 'client_id' else "[FILTERED]") for key,value in params.items()})
...
# GET /lookml_models/
    def get_models(self, fields={}):
        ...
        params = fields
        self.api_logger.info('Request to %s => GET /api/3.0/lookml_models, %s', self.host, params)
...
# GET /lookml_models/{{NAME}}
    def get_model(self, model_name=None, fields={}):
        ...
        params = fields
        self.api_logger.info('Request to %s => GET /api/3.0/lookml_models/%s, %s', self.host, model_name, params)
        r = self.session.get(url, params=params, timeout=60)
        try:
            r.raise_for_status()
        except requests.exceptions.HTTPError as e:
...
# GET /lookml_models/{{NAME}}/explores/{{NAME}}
    def get_explore(self, model_name=None, explore_name=None, fields={}):
        ...
        params = fields
        self.api_logger.info('Request to %s => GET /api/3.0/lookml_models/%s/explores/%s, %s', self.host, model_name, explore_name, params)
        r = self.session.get(url, params=params, timeout=60)
        try:
            r.raise_for_status()
        except requests.exceptions.HTTPError as e:
...
# GET /projects
    def get_projects(self, fields={}):
        ...
        params = fields
        self.api_logger.info('Request to %s => GET /api/3.0/projects, %s', self.host, params)
        r = self.session.get(url, params=params, timeout=60)
        try:
            r.raise_for_status()
        except requests.exceptions.HTTPError as e:
...
# GET /projects/{project_id}
    def get_project(self, project_id=None, fields={}):
        ...
        params = fields
        self.api_logger.info('Request to %s => GET /api/3.0/projects/%s, %s', self.host, project_id, params)
        r = self.session.get(url, params=params, timeout=60)
        try:
            r.raise_for_status()
        except requests.exceptions.HTTPError as e:
...
# GET /projects/{project_id}/files
    def get_project_files(self, project=None, fields={}):
        ...
        params = fields
        self.api_logger.info('Request to %s => GET /api/3.0/projects/%s/files, %s', self.host, project, params)
        r = self.session.get(url, params=params, timeout=60)
        try:
            r.raise_for_status()
        except requests.exceptions.HTTPError as e:
...
# POST /queries/run/{result_format}
    def run_inline_query(self, result_format, body, fields={}):
        ...
        params = fields
        self.api_logger.info('Request to %s => POST /api/3.0/queries/run/%s, %s', self.host, result_format, params)
...
# PATCH session
    def update_session(self, mode):
        ...
        self.api_logger.info('Request to %s => PATCH /api/3.0/session, %s', self.host, body)
...
# GET session
    def get_session(self, fields={}):
        url = 'https://{}:{}/api/3.0/{}'.format(self.host, self.port, 'session')
        params = fields
        self.api_logger.info('Request to %s => GET /api/3.0/session, %s', self.host, params)
        r = self.session.get(url)
        try:
            r.raise_for_status()
        except requests.exceptions.HTTPError as e:
...
# GET /projects/{project_id}/git_connection_tests
    def git_connection_tests(self, project_id, fields={}):
        ...
        params = fields
        self.api_logger.info('Request to %s => GET /api/3.0/projects/%s/git_connection_tests, %s', self.host, project_id, params)
        r = self.session.get(url)
        try:
            r.raise_for_status()
        except requests.exceptions.HTTPError as e:
...
# GET /projects/{project_id}/git_connection_tests/{test_id}
    def run_git_connection_test(self, project_id, test_id, fields={}):
        ...
        params = fields
        self.api_logger.info('Request to %s => GET /api/3.0/projects/%s/git_connection_tests/%s, %s', self.host, project_id, test_id, params)
        r = self.session.get(url)
        try:
            r.raise_for_status()
        except requests.exceptions.HTTPError as e:
...
# GET /connections
    def get_connections(self, fields={}):
        ...
        params = fields
        self.api_logger.info('Request to %s => GET /api/3.0/connections, %s', self.host, params)
        r = self.session.get(url)
        try:
            r.raise_for_status()
        except requests.exceptions.HTTPError as e:
...
# PUT /connections/{connection_name}/test
    def test_connection(self, connection_name, fields={}):
        ...
        params = fields
        self.api_logger.info('Request to %s => POST /api/3.0/connections/%s/test, %s', self.host, connection_name, params)
...
# GET /legacy_features
    def get_legacy_features(self, fields={}):
        ...
        params = fields
        self.api_logger.info('Request to %s => POST /api/3.0/legacy_features, %s', self.host, params)
        r = self.session.get(url)
        try:
            r.raise_for_status()
        except requests.exceptions.HTTPError as e:
...
# GET /integrations
    def get_integrations(self, fields={}):
        ...
        params = fields
        self.api_logger.info('Request to %s => POST /api/3.0/integrations, %s', self.host, params)
        r = self.session.get(url)
        try:
            r.raise_for_status()
        except requests.exceptions.HTTPError as e:
...
# GET /versions
    def get_version(self, fields={}):
        ...
        params = fields
        self.api_logger.info('Request to %s => POST /api/3.0/versions, %s', self.host, params)
        r = self.session.get(url)
        try:
            r.raise_for_status()
        except requests.exceptions.HTTPError as e:
